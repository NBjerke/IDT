...
for line in f:
    ...
    if imuType == 'sparkfun_razor':
        ...
        gyro_z =(( int(csv[7]) * 1/14.375 * pi/180.0-myVariance))*(ts_now - ts_prev);
    ...
    myValue =(myValue + gyro_z) # relevant for the first exercise, then change this.
    myMean = 1/count * myValue
    # in order to show a plot use this function to append your value to a list:
    myVariance = myVariance +  1/count*(myValue - myMean)
